        ...
        AFRAME.registerComponent("orbit-controls", {
            ...
            init: function () {
                (this.sceneEl = this.el.sceneEl),
                    ...
                    this.data.autoVRLookCam &&
                        ...
                        this.el.sceneEl.addEventListener("enter-vr", this.onEnterVR.bind(this), !1),
                        this.el.sceneEl.addEventListener("exit-vr", this.onExitVR.bind(this), !1)),
            ...
            update: function (t) {
                if ((console.log("component update"), this.data.rotateTo)) {
                    var e = new THREE.Vector3(this.data.rotateTo.x, this.data.rotateTo.y, this.data.rotateTo.z);
            ...
            tick: function (t) {
                ...
                e === !0 && this.data.logPosition === !0 && console.log(this.el.object3D.position);
            },
            onEnterVR: function (t) {
                this.saveCameraPose(),
                    ...
                    this.data.autoRotate &&
                        console.warn("orbit-controls: Sorry, autoRotate is not implemented in VR mode");
            },
            onExitVR: function (t) {
                this.lookControls.pause(), this.play(), this.restoreCameraPose(), this.updateView(!0);
            },
            pause: function () {
            ...
            play: function () {
                ...
                this.object.traverse(function (s) {
                    s instanceof THREE.PerspectiveCamera
                        ...
                        : s instanceof THREE.OrthographicCamera && ((t = s), (e = "OrthographicCamera"));
                }),
                    (this.camera = t),
                    (this.cameraType = e),
                    this.sceneEl.addEventListener("renderstart", this.onRenderTargetLoaded, !1),
                    this.lookControls && this.lookControls.pause(),
                    this.canvasEl && this.addEventListeners();
            },
            onRenderTargetLoaded: function () {
                this.sceneEl.removeEventListener("renderstart", this.onRenderTargetLoaded, !1),
            ...
            addEventListeners: function () {
                this.canvasEl.addEventListener("contextmenu", this.onContextMenu, !1),
                    ...
                    this.canvasEl.addEventListener("MozMousePixelScroll", this.onMouseWheel, !1),
            ...
            removeEventListeners: function () {
                this.canvasEl &&
                    (this.canvasEl.removeEventListener("contextmenu", this.onContextMenu, !1),
                    this.canvasEl.removeEventListener("mousedown", this.onMouseDown, !1),
                    this.canvasEl.removeEventListener("mousewheel", this.onMouseWheel, !1),
                    this.canvasEl.removeEventListener("MozMousePixelScroll", this.onMouseWheel, !1),
                    this.canvasEl.removeEventListener("touchstart", this.onTouchStart, !1),
            ...
            onMouseDown: function (t) {
                if (this.data.enabled && this.isRunning) {
                    if (t.button === this.mouseButtons.ORBIT && (t.shiftKey || t.ctrlKey)) {
                        ...
                        if ((this.panOffset.set(0, 0, 0), this.data.enableRotate === !1)) return;
                        this.handleMouseDownRotate(t), (this.state = this.STATE.ROTATE);
                    } else if (t.button === this.mouseButtons.ZOOM) {
                        if ((this.panOffset.set(0, 0, 0), this.data.enableZoom === !1)) return;
            ...
            onTouchStart: function (t) {
                if (this.data.enabled && this.isRunning) {
                    switch (t.touches.length) {
                        case 1:
                            if (this.data.enableRotate === !1) return;
                            this.handleTouchStartRotate(t), (this.state = this.STATE.TOUCH_ROTATE);
                            break;
                        case 2:
                            if (this.data.enableZoom === !1) return;
                            this.handleTouchStartDolly(t), (this.state = this.STATE.TOUCH_DOLLY);
                            break;
                        case 3:
                            if (this.data.enablePan === !1) return;
                    ...
                    this.state !== this.STATE.NONE && this.el.emit("start-drag-orbit-controls", null, !1);
                }
            },
            ...
            handleMouseMoveRotate: function (t) {
                this.rotateEnd.set(t.clientX, t.clientY), this.rotateDelta.subVectors(this.rotateEnd, this.rotateStart);
                var e = this.canvasEl === document ? this.canvasEl.body : this.canvasEl;
                this.rotateLeft(((2 * Math.PI * this.rotateDelta.x) / e.clientWidth) * this.data.rotateSpeed),
                    this.rotateUp(((2 * Math.PI * this.rotateDelta.y) / e.clientHeight) * this.data.rotateSpeed),
            ...
            panHorizontally: function (t, e) {
                ...
                s.setFromMatrixColumn(e, 0), s.multiplyScalar(-t), this.panOffset.add(s);
            },
            ...
            pan: function (t, e) {
                ...
                if ("PerspectiveCamera" === this.cameraType) {
                    ...
                    (o *= Math.tan(((this.camera.fov / 2) * Math.PI) / 180)),
                        this.panHorizontally((2 * t * o) / i.clientHeight, this.object.matrix),
                        this.panVertically((2 * e * o) / i.clientHeight, this.object.matrix);
                } else
                    "OrthographicCamera" === this.cameraType
                        ? (this.panHorizontally(
                              (t * (this.dolly.right - this.dolly.left)) / this.camera.zoom / i.clientWidth,
                              this.object.matrix
                          ),
                          this.panVertically(
                              (e * (this.dolly.top - this.dolly.bottom)) / this.camera.zoom / i.clientHeight,
                              this.object.matrix
                          ))
                        : (console.warn(
            ...
            saveCameraPose: function () {
                this.savedPose || (this.savedPose = { position: this.dolly.position, rotation: this.dolly.rotation });
            },
            ...
            updateView: function (t) {
                ...
                var o = new THREE.Vector3(),
                    n = new THREE.Quaternion().setFromUnitVectors(this.dolly.up, new THREE.Vector3(0, 1, 0)),
                    h = n.clone().inverse();
                if (
                    ...
                    return (
                        ...
                        this.el.setAttribute("rotation", { x: s(r.x), y: s(r.y), z: s(r.z) }),
